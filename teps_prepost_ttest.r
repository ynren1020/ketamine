...
meanpreinf<-round(c(inf1_pre.mean,inf2_pre.mean,inf3_pre.mean,inf4_pre.mean,inf5_pre.mean,inf6_pre.mean),digits=3)
sdpreinf<-round(c(inf1_pre.sd,inf2_pre.sd,inf3_pre.sd,inf4_pre.sd,inf5_pre.sd,inf6_pre.sd),digits=3)
preinf<-paste(meanpreinf,"¡À",sdpreinf,sep="")

meanpostinf<-round(c(inf1_post.mean,inf2_post.mean,inf3_post.mean,inf4_post.mean,inf5_post.mean,inf6_post.mean),digits=3)
sdpostinf<-round(c(inf1_post.sd,inf2_post.sd,inf3_post.sd,inf4_post.sd,inf5_post.sd,inf6_post.sd),digits=3)
twohrpostinf<-paste(meanpostinf,"¡À",sdpostinf,sep="")

meandiff<-round(c(mean(diff_shaps1),mean(diff_shaps2),mean(diff_shaps3),mean(diff_shaps4),mean(diff_shaps5),mean(diff_shaps6)),digits=3)
sddiff<-round(c(sd(diff_shaps1),sd(diff_shaps2),sd(diff_shaps3),sd(diff_shaps4),sd(diff_shaps5),sd(diff_shaps6)),digits=3)
